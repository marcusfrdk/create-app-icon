...
SIZES = {
    ...
    "web": {
        ...
        "152x152:apple-touch-icon-ipad": False,
        "167x167:apple-touch-icon-ipad-retina": False,
        "180x180:apple-touch-icon-iphone-retina": False,
        "196x196:apple-touch-icon": False,
        "196x196:apple-touch-startup-image": False,
        "1200x630:og-image:crop": True
    }
}